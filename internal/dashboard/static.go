...
// serveUI возвращает одинаковую оболочку для главной, preview и прямой ссылки
// графа. Путь выбирает React Router; неизвестные HTTP/API пути не становятся SPA.
