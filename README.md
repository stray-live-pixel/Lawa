...
метаданные файлов; тяжёлые журналы, memory и UML загружаются после фильтрации
только для показанных деревьев. Явный полнотекстовый поиск просматривает их все,
поскольку совпадение может находиться внутри сообщения агента или memory.
