...
по времени создания, а шаги сохраняют порядок исходного workflow; новые события
не переставляют элементы дерева. По умолчанию фильтр «Активные» скрывает полностью завершённые деревья;
