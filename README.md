...
только сцена, кнопка «Босс» из Gravity UI и общий переключатель темы Lawa.
...
Пока это визуальный прототип без подключения к заказам, событиям и переписке
агентов. Комната и персонаж — отдельные PNG в обычной HTML/CSS-вёрстке;
