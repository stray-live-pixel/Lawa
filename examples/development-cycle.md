...
`~/.codex/skills/lawa-frontend/SKILL.md`.
...
передаёт сценарии, материалы и SHA финальному QA. Оба QA получают общие инструкции
запуска браузера, сохранения снимков и публикации через gh. Сбой одного этапа
