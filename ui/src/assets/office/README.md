...
Use case: stylized-concept. Asset: landscape illustration for an HTML isometric office scene. Generate a beautiful minimalist cozy contemporary office as a handcrafted plasticine clay miniature, soft tactile matte clay with subtle finger marks and rounded edges, premium stop-motion set. Orthographic isometric dollhouse view, open front, two low beige walls meeting at rear center, cream floor with a thick softly rounded plinth. Warm pastel beige, oat, ivory and sage green. Tall rounded window in left rear wall letting in warm daylight, a small neutral sofa along left wall, low oak-colored sideboard at rear right with a few books, large leafy indoor plants in clay pots in the two corners, a small rug. No people, no desks, no laptops. Leave a generous completely empty central/front floor for a separate character and desk to be composited later. Entire miniature visible uncropped with generous airy margins, centered in a wide 3:2 canvas. Seamless solid warm off-white background #f4f1eb with a gentle contact shadow under the platform. Soft natural upper-left lighting, ambient occlusion, restrained detail. No text, no interface, no watermarks.
